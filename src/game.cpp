...
namespace ld40 {
	Game::Game() : window(sf::VideoMode(1000.0f, 1000.0f), "LD40", sf::Style::Titlebar | sf::Style::Close), tm(), sm(), fr(this->window, this->tm), state(new MainState(this->window, this->tm, this->sm, this->fr)) {}
